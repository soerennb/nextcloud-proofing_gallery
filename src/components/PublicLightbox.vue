...
const shell = ref<HTMLElement | null>(null), feedbackOpen = ref(false), metadataOpen = ref(false), slideshow = ref(false), shortcutsOpen = ref(false), actionMenuOpen = ref(false)
