...
.annotation-composer button { min-height: 38px; padding: 0 14px; border: 0; border-radius: 8px; background: var(--gallery-accent); color: var(--ion-color-primary-contrast); font: inherit; font-weight: 650; }

.annotation-composer button:last-child { background: rgb(255 255 255 / 12%); color: #fff; }
