...
const emit = defineEmits<{ open: [item: MediaItem, event: MouseEvent]; compare: [item: MediaItem] }>()
	...
	<div class="story-gallery">
		<article v-for="section in sections"
			...
			<div class="story-gallery__frames">
				<figure v-for="item in mediaFor(section)" :key="item.id">
					<button type="button"
